...
questions[[4]] <-c("When variable X values increase, variable Y values also do",
                   "When variable X values increase, variable Y values decrease",
                   "Variables X and Y are independent, there is no relationship among them",
                   "There is a perfect positive relationship among the variables",
                   "There is a perfect negative relationship among the variables",
